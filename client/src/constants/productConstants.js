...
export const  TOPPRODUCTS_LIST_REQUEST =  'TOPPRODUCTS_LIST_REQUEST';
export const  TOPPRODUCTS_LIST_SUCCESS =  'TOPPRODUCTS_LIST_SUCCESS ';
export const  TOPPRODUCTS_LIST_FAIL = 'TOPPRODUCTS_LIST_FAIL';

export const NEWEST_PRODUCT_REQUEST = 'NEWEST_PRODUCT_REQUEST';
export const NEWEST_PRODUCT_SUCCESS = 'NEWEST_PRODUCT_SUCCESS';
export const NEWEST_PRODUCT_FAIL = 'NEWEST_PRODUCT_FAIL';